...
With a clean image of the diffraction pattern, the values of the middle of the images was plotted, and the distance, in pixels, to the first minima was found. From this distance the size of the pixels could be found \emph{REF THEORY}. 

\subsection{Uncertainties}

\subsubsection{Color Camera and White Light}
